...
[y1i,e1i,y1b,e1b,y1l,e1l]=get_times_observations('/Users/irma/Documents/MATLAB/RESULTS/Incremental_May/Incremental/UCI_Adult/Adult_5_RT/','UCI Adult');
...
[y1i,e1i,y1b,e1b,y1l,e1l]=get_processing_times_observations('/Users/irma/Documents/MATLAB/RESULTS/Incremental_May/Incremental/UCI_Adult/Adult_5_RT/');
...
function [mean_time_incr,mean_time_batch,mean_time_lssvm,stdev_time_inct,stdev_time_batch,stdev_time_lssvm]=get_processing_times_observations(path_to_results)
report_points=[];
times_incr=[];
times_batch=[];
samples=[];
