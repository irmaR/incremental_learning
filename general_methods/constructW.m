...
%                                cosine(x_i,x_j). 
%                'balance'       - If nodes i and j are connected, put weight
%                                1/N, where N is the number of datapoints in the example of the same class. This way we impose the penalty on datapoints of the majority class. 
%               
